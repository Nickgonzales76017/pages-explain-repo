...
> Source tree + walkthrough recordings → onboarding guide that publishes itself
...
2. Select a source file or walkthrough recording.
3. Download the intake-ready renamed copy.
4. Open the GitHub `input/` folder from the app and upload that file with GitHub's own web UI.
5. Commit to `main`; the Bonfyre Actions runtime processes it and republishes the guide.
...
git add input/ && git commit -m "add walkthrough"
git push
```
